...
'breadcrumb' => [
{{-- 'notice' => route('admin.notice'), --}}
'notice add' => false,
]
])

@section('notice-title', 'edit notice')
...
@section('content')
    ...
    <div class="row" id="content">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card">
                {!! Form::open([
                    'route' => ['admin.notice.update', $data->id],
                    'autocomplete' => 'off',
                ...
                <div class="card-header">
                    <i class="la la-plus"></i> Create notice
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                            <label for="funded"> Funded By </label> <span class="text-danger">*</span>
                            {!! Form::select('funded_id', $funded, null, [
                                'class' => 'form-control funded',
                                'id' => 'funded_id',
                                'tabindex' => 2,
                                'required' => 'required',
                                'data-error' => 'This field is required',
                            ...
                            @if ($errors->has('funded'))
                                <span class="text-danger"><strong>{{ $errors->first('funded') }}</strong></span>
                            @endif
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-sm-2 col-md-2 col-lg-2 col-xl-9">
                        </div>
                        <div class="form-group col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                            ...
                            @endphp
                            {{-- {{ $data->image }} --}}
                            <div> <a href="{{ URL::to('/uploads/notices/' . $data->image) }}" download>
                                    {{ $data->image }} </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{!! url('/admin/notice') !!}" class="btn btn-default"><span class="la la-ban"></span>
                        &nbsp;Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
