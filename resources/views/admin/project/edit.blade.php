...
'breadcrumb' => [
{{-- 'project' => route('admin.project'), --}}
'project add' => false,
]
])

@section('project-title', 'edit project')
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card">
                ...
                <div class="card-header">
                    <i class="la la-plus"></i> Create project
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                            ...
                            @endphp
                            {{-- {{ $data->image }} --}}
                            <div> <a href="{{ URL::to('/uploads/projects/' . $data->image) }}" download>
                                    {{ $data->image }} </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{!! url('/admin/project') !!}" class="btn btn-default"><span class="la la-ban"></span>
                        &nbsp;Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
